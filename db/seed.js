...
const seedProducts = [
  {name: 'Mozzarella Bufala dop', price: 10.00, stockQuantity: 0, summary: ['Very Good Cheese'], description: 'This mozzeralla is denomination of protected origin (DOP), made with ingredients of Bufala. Has a springier texture and a creamier taste when compared to other mozzarellas.', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'USA', age: 1, milkType: 'cow'},
  {name: 'Ricotta', price: 1.00, stockQuantity: 1, summary: ['Very Good Cheese', 'Limited Supply'], description: 'Ricotta is pure white, firm, rindless cheese. This cheese has a supple, mild taste made from lightly salted sheep\'s milk curd that is pressed and dried, then aged for a minimum of three months', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'USA', age: 1, milkType: 'cow'},
  {name: 'Asiago', price: 0.99, stockQuantity: 1, summary: ['Very Good Cheese'], description: 'Asiago made from pasteurized whole milk and aged for about a month. A young cheese of this age has a full, creamy flavor. Great with crusty Italian bread and glass of Pinot Grigio!', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'USA', age: 5, milkType: 'goat'},
  {name: 'Halloumi', price: 0.01, stockQuantity: 10, summary: ['Very Good Cheese'], description: 'Halloumi has a salty, tangy flavor and a springy texture, similar to Mozzarella. The high melting point allows Halloumi to be grilled without browning. Grilled Halloumi is an excellent appetizer or addition to any main course. Halloumi Cheese is also delicious eaten fresh in salads or sandwiches or with fresh fruit. It is often paired with watermelon in its native Cyprus. Halloumi is often accompanied by mint leaves in the packaging which not only add flavor but also preserve the cheese.', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'USA', age: 1, milkType: 'cow'},
  {name: 'Cheddar', price: 25.50, stockQuantity: 20, summary: ['Very Good Cheese'], description: 'A classic staple', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'USA', age: 4, milkType: 'cow'},
  {name: 'Swiss', price: 10.00, stockQuantity: 30, summary: ['Very Good Cheese'], description: 'Popular worldwide, Swiss is an established type of cheese', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'USA', age: 1, milkType: 'goat'},
  {name: 'Cheddar+', price: 60.99, stockQuantity: 40, summary: ['Very Good Cheese', 'Critics Choice'], description: 'An upgrade over standard Cheddar', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'USA', age: 1, milkType: 'cow'},
  {name: 'Cheddar++', price: 120.00, stockQuantity: 10, summary: ['Very Good Cheese'], description: 'For those who are serious about chedar', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'USA', age: 1, milkType: 'sheep'},
  {name: 'CheddarX', price: 2000.00, stockQuantity: 10, summary: ['Very Good Cheese'], description: 'If price is no issue, this is the best Cheddar available', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'UK', age: 1, milkType: 'cow'},
  {name: 'American', price: 10.00, stockQuantity: 10, summary: ['Very Good Cheese'], description: 'Not technically cheese', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'UK', age: 1, milkType: 'sheep'},
  {name: 'Elite Gold Cheese', price: 3000000.00, stockQuantity: 1, summary: ['Very Good Cheese'], description: 'This is a cheese for the true cheese lover. The flavor and texture are unmatched. Your life will never be the same', imageURL: 'http://i.imgur.com/RlngTOV.jpg', categories: '', tags: [''], location: 'USA', age: 1, milkType: 'cow'},
]
