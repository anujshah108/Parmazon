...
const seedProducts = [
  ...
  {name: 'Brie', price: 10.00, stockQuantity: 1, summary: ['Queen of Cheeses', 'Award Winner'], description: 'Brie is the best known French cheese and has a nickname "The Queen of Cheeses". Brie is a soft cheese named after the French region Brie, where it was originally created. Several hundred years ago, Brie was one of the tributes which had to be paid to the French kings.', imageURL: 'http://www.cheese.com/media/img/cheese/Brie_DAlexis.jpg', category: '', location: 'USA', age: 1, milkType: 'cow'},
